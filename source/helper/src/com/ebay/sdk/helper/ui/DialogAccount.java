...
public class DialogAccount extends JDialog {
    ...
    public DialogAccount(Frame frame, ApiContext apiContext, String title,
        boolean modal, boolean enableApiCredentials) {
    ...
    private void populateUI() {
        this.txtTokenData.setText(
            _apiContext.getApiCredential().geteBayToken());
    ...
    private void jbInit() throws Exception {
        ...
        txtDeveloperID.addActionListener(
            new DialogAccount_txtDeveloperID_actionAdapter(this));
        ...
        txtEpsServerUrl.setText(
            "http://msa-e1.ebay.com/ws/eBayISAPI.dll?EpsBasicApp");
...
class DialogAccount_btnOK_actionAdapter
...
class DialogAccount_txtDeveloperID_actionAdapter
    implements java.awt.event.ActionListener {
    DialogAccount adaptee;
...
class DialogAccount_btnCancel_actionAdapter
    implements java.awt.event.ActionListener {
    DialogAccount adaptee;
...
class DialogAccount_btnFetchToken_actionAdapter
    implements java.awt.event.ActionListener {
    DialogAccount adaptee;
