...
public class GuiUtil {
    ...
    public static java.util.Calendar getCalendarFromField(JTextField txtField)
        ...
        if (txtField.getText().length() > 0) {
            ...
            java.util.Date dt = eBayUtil.fromAPITimeString(txtField.getText());
    ...
    public static TimeFilter getTimeFilterFromFields(JTextField txtFrom,
        JTextField txtTo) throws java.text.ParseException {
    ...
    public static void setTimeFilterFields(int backDays, JTextField txtFrom,
        JTextField txtTo) {
    ...
    public static boolean isApiAccountFilled(ApiAccount ac) {
        ...
        return (dev != null && dev.length() > 0 && app != null
            && app.length() > 0 && cert != null && cert.length() > 0);
    }
     ...
     * @throws SdkException
     */
    public static boolean isTextControlFilled(
        javax.swing.text.JTextComponent tc, String errorMessage)
