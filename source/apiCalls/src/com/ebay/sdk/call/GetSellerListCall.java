...
public class GetSellerListCall extends com.ebay.sdk.ApiCall {
    ...
    public ItemType[] getSellerList()
        ...
        GetSellerListResponseType resp = (GetSellerListResponseType) execute(
            req);

        this.paginationResult = resp.getPaginationResult();
        this.hasMoreItems = (resp.isHasMoreItems() == null ?
            false :
            resp.isHasMoreItems().booleanValue());
        this.returnedItems = (resp.getItemArray() == null ?
            null :
            resp.getItemArray().getItem());
        this.returnedItemsPerPage = resp.getItemsPerPage();
        this.returnedPageNumber = resp.getPageNumber();
        this.returnedItemCountActual = (
            resp.getReturnedItemCountActual() == null ?
                0 :
                resp.getReturnedItemCountActual().intValue());
    ...
    public com.ebay.soap.eBLBaseComponents.ItemType[] getEntireSellerList()
        ...
        while (true) {
            GetSellerListResponseType resp = (GetSellerListResponseType) this.execute(
                req);
            ...
            if (resp.isHasMoreItems() == null || !resp.isHasMoreItems()
                .booleanValue())
                break;
            this.seller = resp.getSeller();
            this.returnedItemCountActual =
