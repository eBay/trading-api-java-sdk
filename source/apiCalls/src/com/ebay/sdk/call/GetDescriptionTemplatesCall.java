...
public class GetDescriptionTemplatesCall extends com.ebay.sdk.ApiCall {
    ...
    public void getDescriptionTemplates()
        ...
        GetDescriptionTemplatesResponseType resp = (GetDescriptionTemplatesResponseType) execute(
            req);

        this.returnedDescriptionTemplate = resp.getDescriptionTemplate();
        this.returnedLayoutTotal = (resp.getLayoutTotal() == null ?
            0 :
            resp.getLayoutTotal().intValue());
        ...
        this.returnedThemeTotal = (resp.getThemeTotal() == null ?
            0 :
            resp.getThemeTotal().intValue());
