...
public class GetAccountCall extends com.ebay.sdk.ApiCall {
    ...
    public AccountEntryType[] getAccount()
        ...
        if (this.viewType.equals(
            AccountHistorySelectionCodeType.BETWEEN_SPECIFIED_DATES)) {
            if (this.viewPeriod == null)
                throw new SdkException("GetAccountCall.ViewPeriod is not set.");
        } else if (this.viewType.equals(
            AccountHistorySelectionCodeType.SPECIFIED_INVOICE)) {
            if (this.invoiceDate == null)
                throw new SdkException(
                    "GetAccountCall.InvoiceDate is not set.");
        }
        ...
        this.accountEntries = (resp.getAccountEntries() == null ?
            null :
            resp.getAccountEntries().getAccountEntry());
        this.paginationResult = resp.getPaginationResult();
        this.hasMoreEntries = (resp.isHasMoreEntries() == null ?
            false :
            resp.isHasMoreEntries().booleanValue());
     ...
     */
    public void setAccountEntrySortType(
