...
public class GetItemTransactionsCall extends com.ebay.sdk.ApiCall {
    ...
    public TransactionType[] getItemTransactions()
        ...
        GetItemTransactionsResponseType resp = (GetItemTransactionsResponseType) execute(
            req);
     ...
     * @throws Exception
     */
    public TransactionType[] getItemTransactions(String itemID,
        ...
        // Call eBay
        GetItemTransactionsResponseType resp = (GetItemTransactionsResponseType) this.execute(
            req);
