...
public class GetMemberMessagesCall extends com.ebay.sdk.ApiCall {
    ...
    public MemberMessageExchangeType[] getMemberMessages()
        ...
        GetMemberMessagesResponseType resp = (GetMemberMessagesResponseType) execute(
            req);

        this.returnedMemberMessages = (resp.getMemberMessage() == null ?
            null :
            resp.getMemberMessage().getMemberMessageExchange());
