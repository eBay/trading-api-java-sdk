...
public class LeaveFeedbackCall extends com.ebay.sdk.ApiCall {
    ...
    public void leaveFeedback()
        ...
        if (this.feedbackDetail.getItemID() == null)
            throw new SdkException(
                "FeedbackDetail.getItemID() property is not set.");
        if (this.feedbackDetail.getCommentText() == null)
            throw new SdkException(
                "FeedbackDetail.getCommentText() property is not set.");
        if (this.feedbackDetail.getCommentType() == null)
            throw new SdkException(
                "FeedbackDetail.getCommentType() property is not set.");
        ...
        if (this.sellerItemRatingDetailArray != null)
            req.setSellerItemRatingDetailArray(
        ...
        LeaveFeedbackResponseType resp = (LeaveFeedbackResponseType) execute(
            req);
     ...
     */
    public void setItemArrivedWithinEDDType(
     ...
     */
    public void setSellerItemRatingDetailArray(
        ItemRatingDetailArrayType sellerItemRatingDetailArray) {
