...
public class GetMyeBaySellingCall extends com.ebay.sdk.ApiCall {
    ...
    public void getMyeBaySelling()
        ...
        GetMyeBaySellingResponseType resp = (GetMyeBaySellingResponseType) execute(
            req);
     ...
     */
    public void setMyeBaySellingRequest(
        GetMyeBaySellingRequestType myeBaySellingRequest) {
     ...
     */
    public void setDeletedFromSoldList(
     ...
     */
    public void setDeletedFromUnsoldList(
