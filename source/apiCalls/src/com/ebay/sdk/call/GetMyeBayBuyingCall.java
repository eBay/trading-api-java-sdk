...
public class GetMyeBayBuyingCall extends com.ebay.sdk.ApiCall {
    ...
    public void getMyeBayBuying()
        ...
        GetMyeBayBuyingResponseType resp = (GetMyeBayBuyingResponseType) execute(
            req);
     ...
     */
    public void setMyeBayBuyingRequest(
        GetMyeBayBuyingRequestType myeBayBuyingRequest) {
     ...
     */
    public void setDeletedFromLostList(
     ...
     */
    public void setDeletedFromWonList(
