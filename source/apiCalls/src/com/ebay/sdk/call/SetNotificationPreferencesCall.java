...
public class SetNotificationPreferencesCall extends com.ebay.sdk.ApiCall {
    ...
    public SetNotificationPreferencesResponseType setNotificationPreferences()
        ...
        if (this.applicationDeliveryPreferences != null)
            req.setApplicationDeliveryPreferences(
                this.applicationDeliveryPreferences);
        if (this.userDeliveryPreferenceArray != null)
            req.setUserDeliveryPreferenceArray(
        ...
        SetNotificationPreferencesResponseType resp = (SetNotificationPreferencesResponseType) execute(
            req);
     ...
     */
    public void setApplicationDeliveryPreferences(
    ...
    public void setEventProperty(
        NotificationEventPropertyType[] eventProperty) {
     ...
     */
    public void setUserDeliveryPreferenceArray(
        NotificationEnableArrayType userDeliveryPreferenceArray) {
