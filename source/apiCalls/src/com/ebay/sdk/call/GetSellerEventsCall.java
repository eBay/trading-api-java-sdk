...
public class GetSellerEventsCall extends com.ebay.sdk.ApiCall {
    ...
    public ItemType[] getSellerEvents()
        ...
        GetSellerEventsResponseType resp = (GetSellerEventsResponseType) execute(
            req);

        this.timeTo = resp.getTimeTo();
        this.returnedSellerEvents = (resp.getItemArray() == null ?
            null :
     ...
     */
    public void setIncludeVariationSpecifics(
        Boolean includeVariationSpecifics) {
