...
public class SetStoreCategoriesCall extends com.ebay.sdk.ApiCall {
    ...
    public long setStoreCategories()
        ...
        if (this.destinationParentCategoryID != null)
            req.setDestinationParentCategoryID(
                this.destinationParentCategoryID);
        if (this.storeCategories != null)
            req.setStoreCategories(this.storeCategories);

        SetStoreCategoriesResponseType resp = (SetStoreCategoriesResponseType) execute(
            req);

        this.returnedTaskID = (resp.getTaskID() == null ?
            0 :
            resp.getTaskID().longValue());
     ...
     */
    public void setDestinationParentCategoryID(
    ...
    public void setStoreCategories(
        StoreCustomCategoryArrayType storeCategories) {
