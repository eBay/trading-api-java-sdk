...
public class GetBestOffersCall extends com.ebay.sdk.ApiCall {
    ...
    public void getBestOffers()
        ...
        GetBestOffersResponseType resp = (GetBestOffersResponseType) execute(
            req);

        this.returnedBestOffers = (resp.getBestOfferArray() == null ?
            null :
            resp.getBestOfferArray().getBestOffer());
