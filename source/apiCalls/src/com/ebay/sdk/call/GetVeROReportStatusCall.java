...
public class GetVeROReportStatusCall extends com.ebay.sdk.ApiCall {
    ...
    public PaginationResultType getVeROReportStatus()
        ...
        GetVeROReportStatusResponseType resp = (GetVeROReportStatusResponseType) execute(
            req);
     ...
     */
    public void setIncludeReportedItemDetails(
        Boolean includeReportedItemDetails) {
