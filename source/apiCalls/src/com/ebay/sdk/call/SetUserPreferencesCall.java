...
public class SetUserPreferencesCall extends com.ebay.sdk.ApiCall {
    ...
    public void setUserPreferences()
        ...
        if (this.sellerFavoriteItemPreferences != null)
            req.setSellerFavoriteItemPreferences(
                this.sellerFavoriteItemPreferences);
        if (this.endOfAuctionEmailPreferences != null)
            req.setEndOfAuctionEmailPreferences(
                this.endOfAuctionEmailPreferences);
        if (this.emailShipmentTrackingNumberPreference != null)
            req.setEmailShipmentTrackingNumberPreference(
                this.emailShipmentTrackingNumberPreference);
        if (this.requiredShipPhoneNumberPreference != null)
            req.setRequiredShipPhoneNumberPreference(
                this.requiredShipPhoneNumberPreference);
        if (this.unpaidItemAssistancePreferences != null)
            req.setUnpaidItemAssistancePreferences(
                this.unpaidItemAssistancePreferences);
        if (this.purchaseReminderEmailPreferences != null)
            req.setPurchaseReminderEmailPreferences(
                this.purchaseReminderEmailPreferences);
        if (this.sellerThirdPartyCheckoutDisabled != null)
            req.setSellerThirdPartyCheckoutDisabled(
                this.sellerThirdPartyCheckoutDisabled);
        if (this.dispatchCutoffTimePreference != null)
            req.setDispatchCutoffTimePreference(
                this.dispatchCutoffTimePreference);
        if (this.globalShippingProgramListingPreference != null)
            req.setGlobalShippingProgramListingPreference(
                this.globalShippingProgramListingPreference);
        if (this.overrideGSPserviceWithIntlService != null)
            req.setOverrideGSPserviceWithIntlService(
                this.overrideGSPserviceWithIntlService);
        if (this.outOfStockControlPreference != null)
            req.setOutOfStockControlPreference(
                this.outOfStockControlPreference);

        SetUserPreferencesResponseType resp = (SetUserPreferencesResponseType) execute(
            req);
     ...
     */
    public void setBidderNoticePreferences(
     ...
     */
    public void setCombinedPaymentPreferences(
     ...
     */
    public void setCrossPromotionPreferences(
     ...
     */
    public void setDispatchCutoffTimePreference(
     ...
     */
    public void setEmailShipmentTrackingNumberPreference(
        Boolean emailShipmentTrackingNumberPreference) {
     ...
     */
    public void setEndOfAuctionEmailPreferences(
     ...
     */
    public void setGlobalShippingProgramListingPreference(
        Boolean globalShippingProgramListingPreference) {
     ...
     */
    public void setOutOfStockControlPreference(
        Boolean outOfStockControlPreference) {
     ...
     */
    public void setOverrideGSPserviceWithIntlService(
        Boolean overrideGSPserviceWithIntlService) {
     ...
     */
    public void setPurchaseReminderEmailPreferences(
     ...
     */
    public void setRequiredShipPhoneNumberPreference(
        Boolean requiredShipPhoneNumberPreference) {
     ...
     */
    public void setSellerFavoriteItemPreferences(
     ...
     */
    public void setSellerPaymentPreferences(
     ...
     */
    public void setSellerThirdPartyCheckoutDisabled(
        Boolean sellerThirdPartyCheckoutDisabled) {
     ...
     */
    public void setUnpaidItemAssistancePreferences(
