...
public class GetMyMessagesCall extends com.ebay.sdk.ApiCall {
    ...
    public void getMyMessages()
        ...
        if (this.includeHighPriorityMessageOnly != null)
            req.setIncludeHighPriorityMessageOnly(
        ...
        this.returnedMyMessages = (resp.getMessages() == null ?
            null :
            resp.getMessages().getMessage());
     ...
     */
    public void setExternalMessageIDs(
        MyMessagesExternalMessageIDArrayType externalMessageIDs) {
     ...
     */
    public void setIncludeHighPriorityMessageOnly(
        Boolean includeHighPriorityMessageOnly) {
