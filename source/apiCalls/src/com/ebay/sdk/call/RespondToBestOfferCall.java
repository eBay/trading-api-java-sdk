...
public class RespondToBestOfferCall extends com.ebay.sdk.ApiCall {
    ...
    public void respondToBestOffer()
        ...
        RespondToBestOfferResponseType resp = (RespondToBestOfferResponseType) execute(
            req);

        this.returnedBestOffers = (resp.getRespondToBestOffer() == null ?
            null :
            resp.getRespondToBestOffer().getBestOffer());
