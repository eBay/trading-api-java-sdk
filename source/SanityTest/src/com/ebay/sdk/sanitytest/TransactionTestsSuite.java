 ...
 * @version 1.0
 */
public class TransactionTestsSuite extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.GetBidderList.class);
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.GetSellerTransactions.class);
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.GetItemTransactions.class);
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.GetAllBidders.class);
        //  suite.addTestSuite(com.ebay.sdk.sanitytest.testcases.ReviseCheckoutStatus.class);
        //commented out 01/02/2024
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.CompleteSale.class);
        ...
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.GetBestOffers.class);
        suite.addTestSuite(
            com.ebay.sdk.sanitytest.testcases.RespondToBestOffer.class);
